class Course:
    ...
    def vyvod(self):
        ...
        for k in self.spisok:
            # print(k['name'])
            if k['course'] == 'python':
                courses['python'].append(k['name'])
            elif k['course'] == 'java':
                courses['java'].append(k['name'])
            elif k['course'] == 'javascript':
                courses['javascript'].append(k['name'])
        print(courses)

    def name_age(self):
        names1 = {}

        for z in self.spisok:
            names = {z['name']:z['age']}
            names1.update(names)
        print(names1)
